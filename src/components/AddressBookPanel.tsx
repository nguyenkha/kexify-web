  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2 px-1">
        ...
        >
          {adding ? t("addressBook.cancel") : `+ ${t("addressBook.add")}`}
        </button>
      </div>
      ...
      <div className="bg-surface-secondary rounded-lg border border-border-primary overflow-hidden">
        ...
        {adding && (
          <div className="px-3 md:px-5 py-3 border-b border-border-secondary space-y-2">
            ...
            >
              <option value="">{t("addressBook.selectChain")}</option>
        ...
        {entries.length > 0 ? (
          ...
          <div className="px-4 py-6 text-center">
            <p className="text-xs text-text-muted">{t("addressBook.noSavedAddresses")}</p>
            <p className="text-[11px] text-text-muted/60 mt-0.5">{t("addressBook.saveAddressesWhenSending")}</p>
          </div>
        ) : null}
        ...
        {recentRecipients.length > 0 && (
          <>
            <div className="px-3 md:px-5 py-2 bg-surface-tertiary/30 border-t border-border-secondary">
              <p className="text-[10px] text-text-muted/60 uppercase tracking-wider font-semibold">{t("addressBook.recentRecipients")}</p>
            </div>
            <div className="divide-y divide-border-secondary">
